...
export function RegenerateSceneModal({
  open,
  onClose,
  scene,
  lang,
      ...
      {open && (
        ...
        >
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted">
                    <span className="font-mono text-accent">{scene.timecode}</span>{" "}
                    · {scene.label[lang]}
                  </p>
                </div>
              </div>
            ...
            <p className="text-sm text-muted">{t.regenSceneHint}</p>

            <div className="flex flex-wrap gap-2">
              {t.sceneFocusChips.map((chip) => {
            ...
            <textarea
              ...
              className="min-h-[88px] w-full resize-y rounded-xl border border-border bg-surface/60 px-4 py-3 text-sm text-foreground placeholder:text-muted-2 outline-none transition-all focus:border-accent focus:ring-4 focus:ring-[var(--ring)]"
            />
